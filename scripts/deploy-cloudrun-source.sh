...
# Usage:
# PROJECT_ID=hrhelper-57162 REGION=us-central1 ADMIN_PASSWORD=xxxx SA_KEY=/path/key.json APP_VERSION=v-1.0.0 ./scripts/deploy-cloudrun-source.sh
...
# Derive APP_VERSION if not provided
